...
const Q4 = () => {
  ...
  const handleNextPagePress = () => {
    // Substitua 'NextPage' pelo nome da sua próxima tela
  ...
  return (
    <View style={styles.container}>
      ...
      <Video
        ref={videoRef}
        source={require('../../assets/videos/cachorro (1).mp4')}
        style={styles.video}
        resizeMode="contain"
        isLooping={true}
        shouldPlay
      ...
      <View style={styles.optionsContainer}>
        <TouchableOpacity style={styles.option} onPress={() => handleAnswer('A')}>
          <Image source={require('../../assets/img/cachorro.png')} style={styles.optionImage} />
        </TouchableOpacity>
