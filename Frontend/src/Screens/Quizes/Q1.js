...
const Q1 = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Video
        ref={videoRef}
        source={require('../../assets/videos/azul.mp4')}
        style={styles.video}
        resizeMode="contain"
        isLooping={true}
        shouldPlay
      ...
      <View style={styles.optionsContainer}>
        <TouchableOpacity style={styles.option} onPress={() => handleAnswer('A')}>
          <Image source={require('../../assets/img/azul.png')} style={styles.optionImage} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.option} onPress={() => handleAnswer('B')}>
          <Image source={require('../../assets/img/amarelo.png')} style={styles.optionImage} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.option} onPress={() => handleAnswer('C')}>
          <Image source={require('../../assets/img/vermelho.png')} style={styles.optionImage} />
        </TouchableOpacity>
      </View>
